...
import { hasValidUserInviteCode, getUserInviteCode, useInviteCode } from '@/lib/invite-code';
import { Alert, AlertDescription } from '@/components/ui/alert';
import { CheckCircle as CheckCircleIcon, Key } from 'lucide-react';
        ...
        <main className="container mx-auto px-4 pb-20">
          ...
          <section className="text-center mb-20">
            <div className="max-w-4xl mx-auto">
              ...
              {/* 邀请码验证成功提示 */}
              {showSuccessMessage && (
                <Alert className="bg-green-50 border-green-200 mb-6 max-w-3xl mx-auto">
                  <CheckCircleIcon className="h-4 w-4 text-green-600" />
                  <AlertDescription className="text-green-800">
                    邀请码验证成功！现在您可以开始使用测评工具了。
                  </AlertDescription>
                </Alert>
              )}
              ...
              {/* 邀请码状态提示 */}
              {!hasValidCode && (
                <Alert className="bg-blue-50 border-blue-200 mb-6 max-w-3xl mx-auto">
          ...
          <section className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-foreground mb-4">评估亮点</h2>
